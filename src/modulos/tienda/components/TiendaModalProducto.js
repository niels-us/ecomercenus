...
import { restarProductoAlCarrito, sumarProductoAlCarrito } from "../../../redux/actions/carritoAction";
...
const TiendaModalProducto = ({ mostrar, setMostrar, objproducto }) => {
  ...
  // console.log(objcarrito.cantidad);
              ...
              <div class="prod w-100">
                <div class="prod-slider-wrap prod-slider-shown">
                  <div class="flexsli prod-slider" id="prod-slider">
                    <ul class="slides">
                      <li>
                        <a data-fancybox-group="prod" class="fancy-img" href={`https://res.cloudinary.com/soluciones-informaticas-nus/` + objproducto.imagen}>
                ...
                <div class="prod-cont">
                  ...
                  <div class="prod-add">
                    ...
                    <p class="qnt-wrap prod-li-qnt">
                      ...
                      <input type="text" value={objcarrito ? objcarrito.cantidad : 0} />
